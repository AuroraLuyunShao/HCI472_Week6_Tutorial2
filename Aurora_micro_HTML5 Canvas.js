...
lib.ssMetadata = [
		{name:"Aurora_micro_HTML5 Canvas_atlas_1", frames: [[0,0,862,1754]]}
];
...
(lib.chromesearch___localntp_localntphtmliPhone6_7_81 = function() {
	this.initialize(ss["Aurora_micro_HTML5 Canvas_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.Aurora_micro_HTML5Canvas = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(6).to({startPosition:0},0).to({scaleY:0.7143,y:470.3},3).to({scaleX:0.7143,scaleY:1.1428,y:370},7,cjs.Ease.quintOut).to({scaleX:1,scaleY:0.7143,y:470.3},7).to({scaleY:1,y:465},4,cjs.Ease.quintOut).wait(3));
...
// library properties:
lib.properties = {
	id: 'E2B3E1121D916B43A939451A15F6C621',
	width: 800,
	height: 600,
	fps: 24,
	color: "#D9D7E4",
	opacity: 1.00,
	manifest: [
		{src:"images/Aurora_micro_HTML5 Canvas_atlas_1.png", id:"Aurora_micro_HTML5 Canvas_atlas_1"}
	],
	preloads: []
};
...
an.compositions['E2B3E1121D916B43A939451A15F6C621'] = {
